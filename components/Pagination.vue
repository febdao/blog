...
export default {
  ...
  computed: {
    buttonStyles() {
      return 'border border-yellow-400 rounded px-4 py-1 text-sm flex justify-center items-center sm:uppercase hover:bg-yellow-500 hover:text-white transform duration-500 ease-in-out';
    },
    disabledStyle() {
      return 'border rounded px-4 py-1 text-sm flex justify-center items-center sm:uppercase text-gray-300';
    },
    totalPages() {
